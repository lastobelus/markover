...
Report a possible violation privately to `lastobelus@mac.com` with the subject
`[Markover conduct]`. Reports will be handled as confidentially as practical.
The maintainer will investigate available messages, logs, or other evidence and
will prioritize the safety and privacy of the people involved.

Markover currently has one maintainer and cannot offer an independent project
enforcement body. If a report concerns the maintainer and also violates
GitHub's policies, use [GitHub's private abuse-reporting
tools](https://support.github.com/contact/report-abuse). This limitation is
stated explicitly rather than implying independent review that does not exist.
...
3) Temporary Suspension
   1) Event: A pattern of repeated violation which the maintainer has tried to
...
4) Permanent Ban
   1) Event: A pattern of repeated code of conduct violations that other steps on
      ...
      maintainer determines there is no way to keep the community safe with this
      person as a member.
...
maintainer's ability to use discretion and judgment in keeping with the best
...
include using an official email address, posting via an official social account,
