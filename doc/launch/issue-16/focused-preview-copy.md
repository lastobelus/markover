# Focused-preview launch copy

These are staging drafts, not published announcements. Issue #17 owns the
audience choice, final release facts, publication timing, and feedback triage.
Each draft keeps the same verified product boundary but asks its audience a
different useful question.
...
window, and chosen community’s native format.
