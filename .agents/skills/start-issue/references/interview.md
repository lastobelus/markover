...
Before the first interview response for a numbered item, verify that both issue
identity lines required by `SKILL.md` have already been emitted. If not, emit
them before the Decision or Question block. This does not apply to routing
