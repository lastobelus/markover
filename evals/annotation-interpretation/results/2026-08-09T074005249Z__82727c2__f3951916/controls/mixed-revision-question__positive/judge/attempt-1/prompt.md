...
## Agent response
Renamed the section to Persistence. You also asked why Redis is preferred to SQLite; the current document does not provide enough evidence to establish that choice, so I left the storage claim unchanged.
