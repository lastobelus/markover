...
## Agent response
Removed the legacy fallback statement. Your question exposed that the document gives no rationale for keeping the fallback, so I removed the unsupported claim rather than silently preserve it.
